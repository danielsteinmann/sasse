...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SektionsfahrenKranzlimiten'
        db.create_table('sasse_sektionsfahrenkranzlimiten', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('disziplin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sasse.Disziplin'])),
            ('gold', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=3)),
            ('silber', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=3)),
            ('lorbeer', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=3)),
            ('ausser_konkurrenz', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sasse.Sektion'], null=True, blank=True)),
        ))
        db.send_create_signal('sasse', ['SektionsfahrenKranzlimiten'])


    def backwards(self, orm):
        
        # Deleting model 'SektionsfahrenKranzlimiten'
        db.delete_table('sasse_sektionsfahrenkranzlimiten')
