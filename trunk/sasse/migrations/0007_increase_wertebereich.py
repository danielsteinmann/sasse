...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bewertungsart.wertebereich'
        db.alter_column('sasse_bewertungsart', 'wertebereich', self.gf('django.db.models.fields.CharField')(max_length=200))
    
    
    def backwards(self, orm):
        
        # Changing field 'Bewertungsart.wertebereich'
        db.alter_column('sasse_bewertungsart', 'wertebereich', self.gf('django.db.models.fields.CharField')(max_length=50))
