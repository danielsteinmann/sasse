...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Schiffeinzel.schiffsart'
        db.delete_column('sasse_schiffeinzel', 'schiffsart')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Schiffeinzel.schiffsart'
        raise RuntimeError("Cannot reverse this migration. 'Schiffeinzel.schiffsart' and its values cannot be restored.")
