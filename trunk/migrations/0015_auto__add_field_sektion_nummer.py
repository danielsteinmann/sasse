...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sektion.nummer', allowing temporarily NULL values
        db.add_column('sasse_sektion', 'nummer', self.gf('django.db.models.fields.CharField')(null=True, unique=True, max_length=2))

        # Wert für die Nummer setzen 
        for s in orm.Sektion.objects.all():
            s.nummer = s.id
            s.save()

        # Do not allow NULL values anymore
        db.alter_column('sasse_sektion', 'nummer', self.gf('django.db.models.fields.CharField')(unique=True, max_length=2))


    def backwards(self, orm):
        
        # Deleting field 'Sektion.nummer'
        db.delete_column('sasse_sektion', 'nummer')
