...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Bewertungsart.defaultwert wird von View bewertung_calc verwendet.
        # PostgreSQL reklamiert, falls man dieses Attribut ändern will solange
        # die View noch existiert.
        cursor.execute("drop view bewertung_calc")
        
        # Changing field 'Kranzlimite.wert'
        db.alter_column('sasse_kranzlimite', 'wert', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=1))

        # Changing field 'Bewertungsart.defaultwert'
        db.alter_column('sasse_bewertungsart', 'defaultwert', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=1))

        # Recreate view
        cursor.execute(BEWERTUNG_CALC)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Kranzlimite.wert'
        db.alter_column('sasse_kranzlimite', 'wert', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Bewertungsart.defaultwert'
        db.alter_column('sasse_bewertungsart', 'defaultwert', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))
