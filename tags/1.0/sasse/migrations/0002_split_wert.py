...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bewertung.note'
        db.add_column('sasse_bewertung', 'note', orm['sasse.bewertung:note'])
        
        # Adding field 'Bewertung.zeit'
        db.add_column('sasse_bewertung', 'zeit', orm['sasse.bewertung:zeit'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Bewertung.note'
        db.delete_column('sasse_bewertung', 'note')
        
        # Deleting field 'Bewertung.zeit'
        db.delete_column('sasse_bewertung', 'zeit')
    ...
    models = {
        'sasse.bewertung': {
            ...
            'note': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '1', 'default': '0'}),
            ...
            'zeit': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2', 'default': '0'})
        },
        'sasse.bewertungsart': {
