...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Mitglied.parent'
        db.delete_column('sasse_mitglied', 'parent_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Mitglied.parent'
        db.add_column('sasse_mitglied', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sasse.Mitglied'], null=True), keep_default=False)
