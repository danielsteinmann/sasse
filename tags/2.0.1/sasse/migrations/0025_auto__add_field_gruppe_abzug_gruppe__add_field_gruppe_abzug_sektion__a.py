...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gruppe.abzug_gruppe'
        db.add_column('sasse_gruppe', 'abzug_gruppe', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=1), keep_default=False)

        # Adding field 'Gruppe.abzug_sektion'
        db.add_column('sasse_gruppe', 'abzug_sektion', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=1), keep_default=False)

        # Adding field 'Gruppe.abzug_gruppe_comment'
        db.add_column('sasse_gruppe', 'abzug_gruppe_comment', self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True), keep_default=False)

        # Adding field 'Gruppe.abzug_sektion_comment'
        db.add_column('sasse_gruppe', 'abzug_sektion_comment', self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Gruppe.abzug_gruppe'
        db.delete_column('sasse_gruppe', 'abzug_gruppe')

        # Deleting field 'Gruppe.abzug_sektion'
        db.delete_column('sasse_gruppe', 'abzug_sektion')

        # Deleting field 'Gruppe.abzug_gruppe_comment'
        db.delete_column('sasse_gruppe', 'abzug_gruppe_comment')

        # Deleting field 'Gruppe.abzug_sektion_comment'
        db.delete_column('sasse_gruppe', 'abzug_sektion_comment')
    ...
    models = {
        ...
        'sasse.gruppe': {
            ...
            'abzug_gruppe': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '1'}),
            'abzug_gruppe_comment': ('django.db.models.fields.CharField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
            'abzug_sektion': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '1'}),
