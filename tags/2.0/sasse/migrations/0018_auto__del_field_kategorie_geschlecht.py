...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Kategorie.geschlecht'
        db.delete_column('sasse_kategorie', 'geschlecht')


    def backwards(self, orm):
        
        # Adding field 'Kategorie.geschlecht'
        db.add_column('sasse_kategorie', 'geschlecht', self.gf('django.db.models.fields.CharField')(default='m', max_length=1), keep_default=False)
