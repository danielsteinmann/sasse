...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Mitglied', fields ['nummer']
        db.create_unique('sasse_mitglied', ['nummer'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Mitglied', fields ['nummer']
        db.delete_unique('sasse_mitglied', ['nummer'])
