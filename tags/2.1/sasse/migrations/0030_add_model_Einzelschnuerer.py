...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Einzelschnuerer'
        db.create_table('sasse_einzelschnuerer', (
            ...
            ('mitglied', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sasse.Mitglied'], unique=True)),
            ('kategorie', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('parcourszeit', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('zuschlaege', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('zeit', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('sasse', ['Einzelschnuerer'])


    def backwards(self, orm):
        
        # Deleting model 'Einzelschnuerer'
        db.delete_table('sasse_einzelschnuerer')
