...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Wettkampf.JPSM'
        db.add_column('sasse_wettkampf', 'JPSM', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Wettkampf.JPSM'
        db.delete_column('sasse_wettkampf', 'JPSM')
