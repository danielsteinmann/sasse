...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Schiffeinzel.steuermann_ist_ds'
        db.add_column('sasse_schiffeinzel', 'steuermann_ist_ds', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Schiffeinzel.vorderfahrer_ist_ds'
        db.add_column('sasse_schiffeinzel', 'vorderfahrer_ist_ds', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Schiffeinzel.steuermann_ist_ds'
        db.delete_column('sasse_schiffeinzel', 'steuermann_ist_ds')

        # Deleting field 'Schiffeinzel.vorderfahrer_ist_ds'
        db.delete_column('sasse_schiffeinzel', 'vorderfahrer_ist_ds')
