...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Bewertung.wert'
        db.delete_column('sasse_bewertung', 'wert')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Bewertung.wert'
        db.add_column('sasse_bewertung', 'wert', orm['sasse.bewertung:wert'])
