...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SpezialwettkaempfeKranzlimite'
        db.create_table('sasse_spezialwettkaempfekranzlimite', (
        ...
        db.send_create_signal('sasse', ['SpezialwettkaempfeKranzlimite'])


    def backwards(self, orm):
        
        # Deleting model 'SpezialwettkaempfeKranzlimite'
        db.delete_table('sasse_spezialwettkaempfekranzlimite')
