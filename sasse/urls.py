...
urlpatterns = patterns('',
    ...
    (r'^(?P<jahr>\d+)/(?P<wettkampf>[-\w]+)/rangliste/pdf/$',
    ...
    (r'^(?P<jahr>\d+)/(?P<wettkampf>[-\w]+)/(?P<disziplin>[-\w]+)/posten/(?P<posten>[-\w]+)/zeiten-sektionsfahren-import/$',
        views.zeiten_sektionsfahren_import, {}, "zeiten_sektionsfahren_import"),
    (r'^(?P<jahr>\d+)/(?P<wettkampf>[-\w]+)/(?P<disziplin>[-\w]+)/posten/(?P<posten>[-\w]+)/noten-einzelfahren-import/$',
    ...
    (r'^(?P<jahr>\d+)/(?P<wettkampf>[-\w]+)/(?P<disziplin>[-\w]+)/sf-null-zeiten/$',
