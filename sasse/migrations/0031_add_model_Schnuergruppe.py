...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Schnuergruppe'
        db.create_table('sasse_schnuergruppe', (
            ...
            ('aufbauzeit', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('abbauzeit', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
        ...
        db.send_create_signal('sasse', ['Schnuergruppe'])


    def backwards(self, orm):
        
        # Deleting model 'Schnuergruppe'
        db.delete_table('sasse_schnuergruppe')
