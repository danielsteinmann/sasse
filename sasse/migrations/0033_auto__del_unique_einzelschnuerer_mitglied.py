...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Einzelschnuerer', fields ['mitglied']
# Wurde manuell entfernt
#        db.delete_unique('sasse_einzelschnuerer', ['mitglied_id'])
        pass


    def backwards(self, orm):
        # Adding unique constraint on 'Einzelschnuerer', fields ['mitglied']
# Wurde manuell entfernt
#        db.create_unique('sasse_einzelschnuerer', ['mitglied_id'])
        pass
