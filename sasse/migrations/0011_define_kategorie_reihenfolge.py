...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for k in orm.Kategorie.objects.all():
            if k.name == 'I':
                k.reihenfolge = 1
                k.geschlecht = 'e' # Egal
            if k.name == 'II': k.reihenfolge = 2
            if k.name == 'III': k.reihenfolge = 3
            if k.name == 'C': k.reihenfolge = 4
            if k.name == 'D': k.reihenfolge = 5
            if k.name == 'F': k.reihenfolge = 6
            k.save()
