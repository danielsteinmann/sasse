...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SektionsfahrenZeitimport', fields ['startnummer_calc', 'schiffsektion']
        db.delete_unique('sasse_sektionsfahrenzeitimport', ['startnummer_calc', 'schiffsektion_id'])

        # Adding unique constraint on 'SektionsfahrenZeitimport', fields ['startnummer_calc', 'posten', 'schiffsektion']
        db.create_unique('sasse_sektionsfahrenzeitimport', ['startnummer_calc', 'posten_id', 'schiffsektion_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SektionsfahrenZeitimport', fields ['startnummer_calc', 'posten', 'schiffsektion']
        db.delete_unique('sasse_sektionsfahrenzeitimport', ['startnummer_calc', 'posten_id', 'schiffsektion_id'])

        # Adding unique constraint on 'SektionsfahrenZeitimport', fields ['startnummer_calc', 'schiffsektion']
        db.create_unique('sasse_sektionsfahrenzeitimport', ['startnummer_calc', 'schiffsektion_id'])
    ...
    models = {
        ...
        'sasse.sektionsfahrenzeitimport': {
            'Meta': {'unique_together': "(['posten', 'schiffsektion', 'startnummer_calc'],)", 'object_name': 'SektionsfahrenZeitimport'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'posten': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sasse.Posten']"}),
