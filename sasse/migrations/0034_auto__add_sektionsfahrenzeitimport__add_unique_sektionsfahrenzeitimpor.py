...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SektionsfahrenZeitimport'
        db.create_table('sasse_sektionsfahrenzeitimport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('schiffsektion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sasse.Schiffsektion'])),
            ('posten', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sasse.Posten'])),
            ('startnummer_calc', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('sasse', ['SektionsfahrenZeitimport'])

        # Adding unique constraint on 'SektionsfahrenZeitimport', fields ['schiffsektion', 'startnummer_calc']
        db.create_unique('sasse_sektionsfahrenzeitimport', ['schiffsektion_id', 'startnummer_calc'])


    def backwards(self, orm):
        # Removing unique constraint on 'SektionsfahrenZeitimport', fields ['schiffsektion', 'startnummer_calc']
        db.delete_unique('sasse_sektionsfahrenzeitimport', ['schiffsektion_id', 'startnummer_calc'])

        # Deleting model 'SektionsfahrenZeitimport'
        db.delete_table('sasse_sektionsfahrenzeitimport')
    ...
    models = {
        ...
        'sasse.sektionsfahrenzeitimport': {
            'Meta': {'unique_together': "(['schiffsektion', 'startnummer_calc'],)", 'object_name': 'SektionsfahrenZeitimport'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'posten': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sasse.Posten']"}),
            'schiffsektion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sasse.Schiffsektion']"}),
            'startnummer_calc': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
