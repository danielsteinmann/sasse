...
- Web Server interaktiv/debugging

	cd c:/djangosites/wettkaempfe
    c:/pythonenv/sasse/Scripts/activate.bat
	uvicorn mysite.asgi:application

- Web Server als Windows Service
  Dazu das Tool "shawl.exe" (https://github.com/mtkennerly/shawl) herunterladen
  und den Service wie folgt erzeugen (CMD als Administrator):
